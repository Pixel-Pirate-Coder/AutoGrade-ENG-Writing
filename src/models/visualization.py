...
def plot_bert_architecture(model, max_size: int = 512,
                            ...
                            show_torchviz_attrs: bool = False,
                            show_torchviz_saved: bool = False) -> Digraph:
    ...
    return make_dot(output, params=dict(model.named_parameters()), show_attrs=show_torchviz_attrs, show_saved=show_torchviz_saved)